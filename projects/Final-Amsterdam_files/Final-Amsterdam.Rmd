---
title: "Model Host: Airbnb Price Predictions for hosts off the beaten path"
...
```
![Amsterdam Apartment, iamsterdam.com](https://www.iamsterdam.com/media/canals-and-cityscapes/sarphatipark-amsterdam-housescc-bysa-40-milliped-via-wikimedia-commons.jpg)
...
```{r outside amenities , include=TRUE, echo = TRUE, message = FALSE, warning = FALSE, cache=TRUE}
